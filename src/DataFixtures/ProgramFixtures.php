...
class ProgramFixtures extends Fixture implements DependentFixtureInterface
{
    public function load(ObjectManager $manager): void
    {
        ...
        $this->addReference('program_The Last Of Us', $program);
        $manager->persist($program);
        $manager->flush();
        ...
        $program->setCategory($this->getReference('category_Aventure'));
        $this->addReference('program_The Good Place', $program);
        $manager->persist($program);
        $manager->flush();
        ...
        $program->setCategory($this->getReference('category_Animation'));
        $this->addReference('program_Hunter X Hunter', $program);
        $manager->persist($program);
        $manager->flush();
        ...
        $this->addReference('program_Game of Thrones', $program);
        $manager->persist($program);
        $manager->flush();
        ...
        $this->addReference('program_The Haunting of Hill House', $program);
        $manager->persist($program);
        $manager->flush();
        ...
        $program->setCategory($this->getReference('category_Horreur'));
        $this->addReference('program_The Originals', $program);
        $manager->persist($program);
        $manager->flush();
    }
